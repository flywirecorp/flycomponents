!(function(e, t) {
  ...
  return (function(e) {
        ...
        e.exports = (function() {
            ...
            if (!e._d) {
              for (
                r = (function(e) {
                  ...
                  e._dayOfYear != null &&
                    ((i = pt(e._a[ye], r[ye])),
                    (e._dayOfYear > De(i) || e._dayOfYear === 0) &&
          ...
          (fn.add = $t),
            ...
            (fn.diff = function(e, t, n) {
              ...
              switch (
                ((a = 6e4 * (r.utcOffset() - this.utcOffset())), (t = F(t)))
              ) {
                case 'year':
                  o = Xt(this, r) / 12;
                  break;
            ...
            (fn.endOf = function(e) {
              return void 0 === (e = F(e)) || e === 'millisecond'
                ? this
                : (e === 'date' && (e = 'day'),
                  this.startOf(e)
            ...
            (fn.get = function(e) {
              return j(this[(e = F(e))]) ? this[e]() : this;
            }),
            ...
            (fn.isAfter = function(e, t) {
              ...
              return (
                ...
                ((t = F(s(t) ? 'millisecond' : t)) === 'millisecond'
            ...
            (fn.set = function(e, t) {
              ...
              else if (j(this[(e = F(e))])) return this[e](t);
              return this;
            }),
          ...
          function _n(e, t, n) {
            ...
            var r,
              a = [];
            for (r = 0; r < 12; r++) a[r] = mn(e, r, n, 'month');
            return a;
          }
          function yn(e, t, n, r) {
            typeof e === 'boolean'
            ...
            var a,
              o = ft(),
              i = e ? o._week.dow : 0;
            if (n != null) return mn(t, (n + i) % 7, r, 'day');
            var s = [];
            for (a = 0; a < 7; a++) s[a] = mn(t, (a + i) % 7, r, 'day');
            return s;
          }
    ...
    function(e, t, n) {
      'use strict';
      Object.defineProperty(t, '__esModule', { value: !0 }),
        (t.Radio = t.TextInput = t.Textarea = t.Tabs = t.Switch = t.Select = t.Rating = t.PhoneNumber = t.MultipleCheckbox = t.MoneyInput = t.Modal = t.InputGroup = t.Input = t.Heading = t.FormGroup = t.FileInput = t.Datepicker = t.Checkbox = t.Button = t.Autocomplete = t.Alert = t.Accordion = void 0);
      var r = Y(n(33)),
        a = Y(n(41)),
        o = Y(n(43)),
        i = Y(n(56)),
      ...
      (t.Accordion = r.default),
        ...
        (t.FileInput = l.default),
        (t.FormGroup = d.default),
        (t.Heading = c.default),
        (t.Input = f.default),
        (t.InputGroup = h.default),
        (t.Modal = p.default),
        (t.MoneyInput = m.default),
        (t.MultipleCheckbox = _.default),
        (t.PhoneNumber = y.default),
        (t.Rating = v.default),
        (t.Select = b.default),
        (t.Switch = k.default),
        (t.Tabs = g.default),
              ...
              },
              {
                ...
                value: function() {
                  ...
                  if (t) {
                    ...
                    e !== _ && (0, c.default)(t, n, { onlyScrollIfNeeded: !0 });
                  }
                }
              },
              {
          ...
          a(t, [
            {
              ...
              value: function() {
                ...
                return s.default.createElement(
                  ...
                  typeof p === 'function' ? p(r({}, i, { label: _ })) : _
                );
              }
            }
          ]),
              ...
              value: function() {
                ...
                return i.default.createElement(
                  ...
                  i.default.createElement(
                    'div',
                    {
                      className: (0, u.default)('Datepicker', { 'is-open': _ })
                    },
          ...
          return (
            (n.handleBlur = function(e) {
              var t = n.props.onBlur,
                ...
                a = r.name,
                o = r.value,
                i = n.convertToCents(o);
              t(a, i), n.setState({ amount: i, isFocused: !1 });
            }),
            ...
            (n.handleKeyDown = function(e) {
              var t = /\d/.test(String.fromCharCode(e.keyCode)),
                n = [
                  188,
                  110,
                  8,
      ...
      var f = {},
        ...
        p = (function(e) {
          function t(e) {
            ...
            m.call(n), (n.numberInputRef = s.default.createRef());
            var r = n.props.value,
              a = void 0 === r ? h : r,
              o = n.getCountryFrom(a),
              i = o.value,
              u = o.phonePattern,
              l = n.formatNumber(a, u);
            return (
              (n.state = {
                formattedNumber: l,
                isFocused: !1,
            ...
            a(t, [
              {
                ...
                value: function(e) {
                  return (
                    this.props.countries.find(function(t) {
                      return t.value === e;
                    }) || f
                  );
                }
              },
              {
                key: 'getCountryFrom',
                value: function(e) {
                  var t = this.props.countries,
                    n = (this.state || {}).preferredCountryIsoCode,
                    r = e.replace(/\D/g, ''),
                    a = t.filter(function(e) {
                      return r.startsWith(e.dialingCode);
                    });
                  return a.length === 0
                    ? f
                    : a.find(function(e) {
              ...
              },
              {
                key: 'formatNumber',
                value: function(e, t) {
                  return (0, l.applyPattern)(e, t, { ignoreExcedingText: !1 });
                }
              },
              {
                key: 'sendChange',
        ...
        (this.handleBlur = function() {
          ...
          (this.handleChange = function(t) {
            var n = t.target,
              r = n.value,
              a = n.selectionStart,
              o = e.getCountryFrom(r),
              i = o.phonePattern,
              s = o.value,
              u = r.replace(/(?!^\+)\D/gm, '');
            i && (u = e.formatNumber(u, i)),
              e.setState(
                { selectedCountry: s, formattedNumber: u },
                function() {
                  e.sendChange(u), e.setCaretPosition(a, r, u);
                }
              );
          }),
          (this.setCaretPosition = function(t, n, r) {
            var a = e.getSeparatorsToPosition(n, t),
              o = e.getSeparatorsToPosition(r, t),
              i = r.length - n.length,
              s = o.length - a.length,
              u = e.hasFormatChange(i, s) ? t + (i || 1) : t;
            e.numberInputRef.current.setSelectionRange(u, u);
          }),
          (this.getSeparatorsToPosition = function(e, t) {
            return (e && e.substring(0, t).match(/[^0-9]/g)) || [];
          }),
          (this.hasFormatChange = function(e, t) {
            return e >= 0 && t !== 0;
          }),
          (this.handleCountryClick = function(t) {
            var n = e.state,
              r = n.selectedCountry,
              a = n.formattedNumber,
              o = e.getCountry(r).dialingCode,
              i = e.getCountry(t),
              s = i.dialingCode,
              u = i.phonePattern,
              l = (a || s).replace(/\D/g, '').replace(o, s);
            e.setState({
              preferredCountryIsoCode: t,
              selectedCountry: t,
              formattedNumber: e.formatNumber(l, u)
            });
          }),
          (this.handleFocus = function() {
            var t = e.props,
        ...
        O = (t.FlagSelector = (function(e) {
          function t(e) {
            ...
            return (
              ...
              (n.handleMenuKeydown = function(e) {
                switch (
                  (_.includes(e.keyCode) && e.preventDefault(),
                  n.showOptions(),
                  e.keyCode)
                ) {
                  case g:
                    return n.moveIndexUp();
                  case b:
                    return n.moveIndexDown();
                  case y:
                    return n.selectCurrentOption();
                  case v:
                    return n.hideOptions();
                  default:
                    return n.handleTypedChar(e.keyCode);
                }
              }),
              (n.handleOptionSelected = function(e) {
                var t = n.getOptionIndexByValue(e);
                n.hideOptions(),
                  n.setState(function() {
                    return { isOpen: !1, selectedIndex: t };
                  }, n.sendChange(e));
              }),
              (n.state = {
                isOpen: !1,
            ...
            r(t, [
              ...
              },
              {
                ...
                value: function() {
                  ...
                  e !== m && (0, d.default)(t, n, { onlyScrollIfNeeded: !0 });
                }
              },
              {
                key: 'handleClickOutside',
              ...
              },
              {
                ...
                get: function() {
                  return this.props.options.filter(function(e) {
                    var t = e.dialingCode,
                      n = e.phonePattern;
                    return !(0, h.default)(t) && !(0, h.default)(n);
                  });
                }
              }
            ]),
    ...
    function(e, t, n) {
      ...
      (l.propTypes = {
        ...
        (l.defaultProps = { children: null, defaultActiveIndex: 0 }),
        (t.default = l);
    },
    function(e, t, n) {
      'use strict';
